...
To use your library logo (not the OTB <prm-logo></prm-logo>) you can use your own html, with an img element that has a data-logo attribute with a value of "email-template" immediatly following the opening tag, for example:
 ...
 <table height="60px" width="600" cellpadding="0" cellspacing="0" border="0" align="center" class="wrapper" bgcolor="#17bef7">
    ...
    <tr>
        <td align="center" bgcolor="#eeeeee">
            <img class="logo-image" data-logo="email-template" translate-attr="{ alt: 'nui.header.LogoAlt' }" height="60" style="height:60px;max-height:60px;background-color:#17bef7;">
        </td>
    </tr>
    </tbody>
</table>
